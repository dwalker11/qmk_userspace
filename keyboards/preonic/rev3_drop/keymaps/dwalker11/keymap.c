...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  OS_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,      KC_B,   KC_N,   KC_M,       KC_COMM, KC_DOT,  KC_SLSH,  RSFT_T(KC_ENT), \
  OSL(6),  OS_LCTL, OS_LGUI, OS_LALT, TG(LOWER), KC_SPC, KC_SPC, OSL(RAISE), KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT         \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   XXXXXXX, XXXXXXX, KC_4,    KC_5,    KC_6,    KC_DOT,  _______, \
  _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   XXXXXXX, XXXXXXX, KC_1,    KC_2,    KC_3,    XXXXXXX, _______, \
  _______, KC_F9,   KC_F11,  KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
