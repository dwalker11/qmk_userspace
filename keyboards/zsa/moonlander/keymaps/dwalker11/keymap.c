...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        CW_TOGG,  TG(NUM), XXXXXXX,   KC_LEFT, KC_RGHT,          CTL_ESC,        KC_ENT,             KC_DOWN, KC_UP,   XXXXXXX,  OS_LALT, KC_DEL,
                                               KC_SPC,  OS_LSFT, OS_LGUI,        OS_LCTL, OSL(SYMB), KC_SPC
    ),
    ...
    [SYMB] = LAYOUT(
        ...
        _______, KC_CIRC, KC_AMPR, KC_ASTR, _______, KC_LPRN, _______,           _______, KC_RPRN, KC_MINS, KC_EQL,  _______, KC_COLN, KC_GRV,
    ...
    [NUM] = LAYOUT(
        ...
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______,           _______, _______, KC_4,    KC_5,    KC_6,    _______, _______,
        _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______,           _______, _______, KC_1,    KC_2,    KC_3,    _______, _______,
        _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,                             _______, _______, KC_0,    _______, _______, _______,
        _______, _______, _______, _______, _______,          _______,           _______,          KC_ASTR, KC_PLUS, KC_BSLS, KC_EQL, _______,
                                            _______, _______, _______,           _______, _______, _______
    ),
