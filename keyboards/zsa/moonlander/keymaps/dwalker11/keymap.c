...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUM] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______,           _______, _______, KC_7,    KC_8,    KC_9,    _______, KC_ASTR,
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______,           _______, _______, KC_4,    KC_5,    KC_6,    _______, KC_PLUS,
        _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______,           _______, _______, KC_1,    KC_2,    KC_3,    _______, KC_BSLS,
        _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,                             _______, _______, KC_0,    _______, _______, KC_EQL,
        _______, _______, _______, _______, _______,          _______,           _______,          _______, _______, _______, _______, _______,
                                            _______, _______, _______,           _______, _______, _______
    ),
